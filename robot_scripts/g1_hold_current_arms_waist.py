...
def main():
    ...
    input("Press Enter to HOLD CURRENT WAIST+ARM POSE for 3 seconds. Keep e-stop ready...")
    ...
    print("Holding current waist + arm pose...")
    ...
    print("Done. Waist and arms should not have moved.")
